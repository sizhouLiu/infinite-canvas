export default {
    ...
    canvas: {
        ...
        model3d: { loading: "Loading 3D model", loadFailed: "Could not load the 3D model", empty: "No 3D model yet", generating: "Generating 3D model", clip: "Animation", boneCount: "Bones: {{count}}", clipCount: "Animation: {{count}} clip(s)", rigged: "Rigged", staticMesh: "Static mesh", resetCamera: "Reset camera", play: "Play animation", pause: "Pause animation", modes: { shaded: "Shaded", clay: "Clay", claywire: "Clay + wire", wireframe: "Wireframe", skeleton: "Skeleton" } },
        toolbar: {
