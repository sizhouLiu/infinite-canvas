export default {
    ...
    canvas: {
        ...
        configNode: { title: "Generation config", image: "Image", text: "Text", video: "Video", audio: "Audio", model3d: "3D", prompt: "Prompt", references: "Reference images", videoReferences: "Reference videos", audioReferences: "Reference audio", items: "{{count}} items", images: "{{count}} images", compose: "Compose prompt", stop: "Stop", generate: "Generate" },
