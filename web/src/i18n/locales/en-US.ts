export default {
    ...
    canvas: {
        ...
        projectPage: { multiviewGroupTitle: "Four views", model3dMultiviewTrimmed: "Multiview supports at most {{count}} images; the first {{count}} were used", multiviewPartialFailure: "{{count}} view(s) failed to generate; the rest were kept", multiviewRateLimited: "Hit the generation limit; retrying this view in {{seconds}}s",
