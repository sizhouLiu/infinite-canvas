export default {
    ...
    settingsPanels: {
        ...
        image: { title: "Image settings", quality: "Quality", size: "Size", align16: "Align to multiples of 16", align16Hint: "Round dimensions up to the next multiple of 16 after input", resolution: "Resolution", aspectRatio: "Aspect ratio", transparent: "Transparent background", transparentHint: "Generate an image without a background when supported by the model", template: "Template", templateHint: "When set, the prompt becomes optional.", templates: { none: "None", t_pose: "T-pose", character_completion: "Character completion", "3d_enhance": "3D enhance", variants: "Variants", figure: "Figure" }, count: "Image count", images: "{{count}} images" },
        ...
        model3d: { title: "3D settings", texture: "Texture", pbr: "PBR material", textureQuality: "Texture quality", faceLimit: "Face limit", faceLimitAuto: "Auto", topology: "Topology", topologies: { false: "Triangles", true: "Quads" }, quadHint: "Quads are supported only by P2 and v3.0+ models. On the H series (v3.x) the output becomes FBX, which cannot be previewed on the canvas — only downloaded. Face limits are lower too (P2 allows 48–25,000).", onOff: { true: "On", false: "Off" }, qualities: { standard: "Standard", detailed: "Detailed", extreme: "Extreme" } },
        text: { title: "Text settings", reasoning: "Reasoning effort", count: "Generation count" },
        model: { select: "Select model", assign: "Assign a model for {{capability}} in the provider settings", noMatch: "No matching {{capability}} models", addFirst: "Add a provider and models in Settings first", capabilities: { image: "image generation", video: "video", text: "text", audio: "audio", model3d: "3D" } },
    },
    ...
    modelPlugin: {
        ...
        templates: { openai: "OpenAI format", gemini: "Gemini format", tripo: "Tripo format" },
        authoring: {
    ...
    assets: {
        ...
        kinds: { text: "Text", image: "Image", video: "Video", audio: "Audio", model3d: "3D model" },
        fields: {
            title: "Title",
    ...
    canvas: {
        ...
        nodeTypes: { image: "Image", text: "Text", config: "Generation config", video: "Video", audio: "Audio", model3d: "3D model", group: "Group" },
        model3d: { loading: "Loading 3D model", loadFailed: "Could not load the 3D model", empty: "No 3D model yet", generating: "Generating 3D model", clip: "Animation", boneCount: "Bones: {{count}}", clipCount: "Animation: {{count}} clip(s)", rigged: "Rigged", staticMesh: "Static mesh", activate: "Click to load model", resetCamera: "Reset camera", play: "Play animation", pause: "Pause animation", captureView: "Export this view as an image", captureTitle: "{{name}} view", captured: "Image node created", captureFailed: "Could not export this view. Try again.", modes: { shaded: "Shaded", basecolor: "Base color", clay: "Clay", claywire: "Clay + wire", wireframe: "Wireframe", skeleton: "Skeleton" } },
        toolbar: {
        ...
        createMenu: {
            fromNode: "Generate from this node", close: "Close", text: "Generate text", textDescription: "Scripts, ad copy, and brand content", image: "Generate image", video: "Generate video", audio: "Audio reference", model3d: "Generate 3D", config: "Configuration node", configDescription: "Model, size, count, and input order", select: "Select a node",
        },
        node: {
            node: "Node",
        ...
        model3dOps: { title: "3D ops", run: "Run", editMultiview: "Edit multiview", editMultiviewHint: "Fill in only the views you want changed; blank views stay as they are.", editMultiviewPlaceholder: "e.g. make the coat red", ops: { texture: "Retexture", convert: "Convert format", rig: "Auto-rig", retarget: "Apply animation", segment: "Segment parts", complete: "Complete mesh", decimate: "Decimate", multiview: "Multiview" }, fields: { model: "Model", textureQuality: "Texture quality", pbr: "PBR material", format: "Target format", quad: "Quad faces", faceLimit: "Face limit", rigType: "Rig type", spec: "Bone spec", outFormat: "Output format", animation: "Animation", animateInPlace: "Animate in place", granularity: "Granularity", splitByConnectivity: "Split by connectivity", splitParts: "Split into part nodes", completionMode: "Completion mode" }, rigTypes: { biped: "Biped", quadruped: "Quadruped", hexapod: "Hexapod", octopod: "Octopod", avian: "Avian", serpentine: "Serpentine", aquatic: "Aquatic" }, granularities: { simple: "Simple", balanced: "Balanced", detailed: "Detailed" }, completionModes: { ai_completion: "AI completion", quick_cap: "Quick cap" }, views: { front: "Front", left: "Left", back: "Back", right: "Right" }, requires: { rig: "Auto-rig this model first — applying an animation only works on a node rigged in this canvas", segment: "Segment this model first — mesh completion only works on a node segmented in this canvas" }, notRiggable: "Tripo reports this model cannot be rigged (detected as {{type}}); stopped before spending credits", noAnimationForRigType: "No preset animations for this rig type", rigModelHint: "{{model}} is recommended — it offers more preset animations", downloadConverted: "Download {{ext}}", convertDone: "Converted to {{ext}} — download it from the 3D ops menu", convertedMissing: "The converted file is gone; run the conversion again", splitDone: "Split into {{count}} part nodes", splitNoParts: "This model has no recognizable part names to split; try again with the v2.0 segmentation model" }, blenderBridge: { title: "Import to Blender", label: "Import to Blender", importing: "Importing {{count}} model(s) into Blender…", imported: "Imported {{count}} model(s) into Blender", none: "No importable 3D models in the selection", missing: "The model file for “{{name}}” is missing", unsupported: "“{{name}}” uses {{format}}, which the Blender addon does not support. Convert to GLB / FBX / OBJ / STL / USDZ first.", busy: "An import into Blender is already running", connectFailed: "Could not reach Blender at ws://127.0.0.1:60600. Enable the Tripo Bridge addon in a local Blender first.", handshakeFailed: "Handshake with Blender failed. Check that the Tripo Bridge addon is enabled.", timeout: "Timed out waiting for Blender. Check that the addon is still running.", transferFailed: "Failed to transfer “{{name}}”", importFailed: "Failed to import “{{name}}”{{reason}}", mixedHttps: "This page is HTTPS, so the browser cannot open a local ws:// socket. Open the canvas at http://localhost:3000 and import from there." }, bambuStudio: { title: "Open in Bambu Studio", label: "Open in Bambu Studio", opening: "Opening {{count}} model(s) in Bambu Studio…", opened: "Opened {{count}} model(s) in Bambu Studio", converting: "Converting {{count}} model(s) to 3MF…", busy: "“{{name}}” is already being processed. Wait for it to finish before opening Bambu Studio.", configRequired: "Configure a Tripo channel first so the model can be converted to 3MF.", none: "No 3D models in the selection that Bambu Studio can open", missing: "The 3MF file for “{{name}}” is missing", needConvert: "“{{name}}” has no 3MF yet. Convert it to 3MF from 3D ops first.", agentRequired: "A local 3MF needs Canvas Agent to host it briefly so Bambu Studio can download it. Connect the local Agent, or convert again to reuse Tripo’s download URL.", openFailed: "Could not launch Bambu Studio. Confirm it is installed and the bambustudio:// protocol is registered." }, videoFrames: { first: "Capture first frame", last: "Capture last frame", current: "Capture current frame", firstTitle: "{{name}} first frame", lastTitle: "{{name}} last frame", currentTitle: "{{name}} current frame", captured: "Image node created", failed: "Could not capture this frame. Try again." },
        sidePanel: {
            canvas: "Canvas", assets: "Assets", prompts: "Prompt Library", history: "History", resize: "Resize left panel", elements: "Canvas elements", select: "Select", searchNodes: "Search nodes", focusNode: "Focus node", preview: "Large preview", noNodes: "No nodes on this canvas", clearAll: "Clear all", selected: "{{count}} selected", exporting: "Exporting selected elements…", exportName: "canvas-elements-{{count}}", exported: "Exported {{count}} elements", exportFailed: "Export failed. Try again.",
            ...
            filter: { image: "Image", video: "Video", text: "Text", audio: "Audio", model3d: "3D", config: "Configuration", group: "Group" },
            historyRuns: "Generation runs", searchHistory: "Search prompt, model, or task ID", noHistory: "No generation history yet", copyTaskId: "Copy task ID", taskIdCopied: "Task ID copied", noTaskId: "This record has no task ID", historyNodeGone: "The node was deleted", removeHistoryTitle: "Delete this record?", clearHistory: "Clear", clearHistoryTitle: "Clear this canvas's generation history?", historyCleared: "Generation history cleared", historyMetaOnly: "Only the task ID, prompt, and result path are recorded. Once a node is deleted its file may be garbage-collected, but the record still lets you look the task up or generate again.",
            historyKind: { image: "Image", video: "Video", audio: "Audio", model3d: "3D", multiview: "Multiview", model3dOp: "3D operation" },
        },
        assetPicker: { title: "Select assets", insert: "Insert", search: "Search assets", empty: "No assets" },
        imageTools: { copyPrompt: "Copy prompt", copyPromptTitle: "Copy the prompt used to generate this image", reversePrompt: "Reverse prompt", reversePromptTitle: "Create text and configuration nodes to infer the prompt", replace: "Replace image", locked: "Lock ratio", free: "Free ratio", lockTitle: "Switch to proportional scaling", freeTitle: "Switch to free resizing", mask: "Local edit", maskTitle: "Paint a mask and edit the selected area", crop: "Crop", cropTitle: "Crop into a new node", split: "Split", splitTitle: "Split the image by rows and columns", decompose: "Decompose", decomposeTitle: "Break the scene into its objects and generate each one", multiview: "Multiview", multiviewTitle: "Generate four views with Tripo (consumes credits)", builtinMultiview: "Four views", builtinMultiviewTitle: "Generate front/left/back/right views with the current image model (no Tripo)", upscale: "Upscale", upscaleTitle: "Increase image resolution", superResolve: "Super resolution", superResolveTitle: "AI super resolution", angle: "Multi-angle", angleTitle: "Generate another angle", view: "View image", viewTitle: "View image details", more: "More", configure: "Configure quick tools", customize: "Customize toolbar", showLabels: "Show button labels", description: "Choose the quick tools shown in the image-node toolbar.", preview: "Node preview", imageNode: "Image node", quickTools: "Quick tools" },
        nodeToolbar: { noPrompt: "No prompt to copy", infoTitle: "View node information", info: "Info", removeTitle: "Remove node", retryTitle: "Generate again", queryVideoTask: "Get task status", queryVideoTaskTitle: "Query video generation status by task ID", videoTaskId: "Task ID", saveAsset: "Save asset", downloadAudio: "Download audio", downloadModel3d: "Download 3D model", downloadVideo: "Download video", downloadImage: "Download image", editTextTitle: "Edit text", editText: "Edit text", decreaseFont: "Decrease font size", increaseFont: "Increase font size", zoomOut: "Smaller", zoomIn: "Larger", uploadImage: "Upload image", replaceVideo: "Replace video", uploadVideo: "Upload video", replaceAudio: "Replace audio", uploadAudio: "Upload audio", nodeInfo: "Node information", name: "Name", type: "Type", size: "Size", position: "Position", status: "Status", imageGroup: "Image group", imageSize: "Image size", group: "Group", groupTitle: "Wrap selected nodes in a group", ungroup: "Ungroup", ungroupTitle: "Remove grouping from selected nodes" },
        configNode: { title: "Generation config", image: "Image", text: "Text", video: "Video", audio: "Audio", model3d: "3D", prompt: "Prompt", references: "Reference images", videoReferences: "Reference videos", audioReferences: "Reference audio", items: "{{count}} items", images: "{{count}} images", compose: "Compose prompt", stop: "Stop", generate: "Generate", parameterSource: "Parameter node, used by {{count}} downstream node(s)" },
        parameters: { title: "Parameters", inherited: "Parameters come from the upstream config node \"{{title}}\"", focusSource: "Go to config node", disconnectSource: "Disconnect config node" },
        multiview: { assignTitle: "Choose the view this image feeds", unassigned: "Unassigned" },
        projectPage: { multiviewGroupTitle: "Four views", model3dMultiviewTrimmed: "Multiview supports at most {{count}} images; the first {{count}} were used", multiviewPartialFailure: "{{count}} view(s) failed to generate; the rest were kept", multiviewRateLimited: "Hit the generation limit; retrying this view in {{seconds}}s", decomposeGroupTitle: "Scene components", decomposePartialFailure: "{{count}} component(s) failed to generate; the rest were kept", decomposeRateLimited: "Hit the generation limit; retrying this component in {{seconds}}s",
        ...
        decompose: {
            title: "Decompose scene",
            description: "Find the objects that can be lifted out of the picture, then generate each one on a transparent background.",
            analyzing: "Finding the objects in this picture…",
            analyzeFailed: "Could not read the component list",
            configMissing: "Configure a text model first",
            components: "Components ({{count}})",
            reanalyze: "Analyze again",
            add: "Add an item",
            remove: "Remove this item",
            empty: "No separable objects were found. Add one by hand or analyze again.",
            namePlaceholder: "Object name",
            truncated: "At most {{count}} components; the rest were dropped by visual importance",
            opaqueBackground: "The current image model has no transparent background, so components will come out opaque.",
            generate: "Generate {{count}} components",
        },
        editors: {
        ...
        promptPanel: { model3d: "Describe the 3D model you want to generate", model3dSingleImageHint: "1 image connected — this runs image-to-3D and needs no prompt", model3dMultiviewHint: "{{count}} images connected — this runs multiview-to-3D and needs no prompt. Plug a single image into the matching left-side socket, or mark front/left/back/right on images inside a group; unmarked images fill the remaining angles in connection order.", model3dMultiviewTrimmedHint: "{{count}} images connected — multiview uses at most the first {{max}}, and needs no prompt. Plug a single image into the matching left-side socket, or mark front/left/back/right on images inside a group; unmarked images fill the remaining angles in connection order.", video: "Describe the video you want to generate", audio: "Describe the audio you want to generate", image: "Describe the image you want to generate", text: "Describe the text you want to generate", editImage: "Describe how you want to change this image", editText: "Describe how you want to revise this text", expandEditor: "Expand editor", editorTitle: "Edit prompt", stopGeneration: "Stop generation", generate: "Generate", stop: "Stop" },
    ...
    config: {
        ...
        proxy: {
            ...
            hostedTitle: "Forwarding proxy",
            hostedDescription: "This deployment includes a same-origin forwarding proxy. Generation requests go through this site to the upstream API so the browser is not blocked by CORS. API keys stay in your browser and are forwarded in request headers; the site does not store them.",
            hostedAddressDescription: "Injected by the deployment. You do not need to run a proxy command on your machine.",
            hostedChannelHint: "Keep the real endpoint in Providers. A custom channel whose host is not on the allowlist will be refused; the operator can add it via PROXY_ALLOW_HOSTS.",
            test: "Test connection",
            available: "Proxy is reachable ({{proxy}})",
            missingUrl: "Enter the proxy address first.",
            unreachable: "The proxy is unreachable. Check that the address is correct.",
        },
        localStorage: {
        ...
        channels: {
            ...
            defaultName: "Default provider", tripoCnName: "Tripo China", tripoGlobalName: "Tripo Global",
        ...
        preferences: {
            ...
            defaultModel3dModel: "Default 3D model",
        ...
        channelEditor: {
            tripoRegion: "Tripo region", tripoRegionHint: "The China and global sites are separate accounts and their API keys are not interchangeable; you can also enter a custom URL below.", tripoRegions: { cn: "China (.com)", global: "Global (.ai)" },
            title: "Edit provider",
            name: "Provider name",
            protocol: "Protocol",
