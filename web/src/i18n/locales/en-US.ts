export default {
    ...
    canvas: {
        ...
        model3d: { loading: "Loading 3D model", loadFailed: "Could not load the 3D model", empty: "No 3D model yet", generating: "Generating 3D model" },
        toolbar: {
        ...
        projectPage: { model3dMultiviewTrimmed: "Multiview supports at most {{count}} images; the first {{count}} were used",
