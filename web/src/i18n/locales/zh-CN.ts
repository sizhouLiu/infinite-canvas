export default {
    ...
    canvas: {
        ...
        model3d: { loading: "正在加载 3D 模型", loadFailed: "3D 模型加载失败", empty: "暂无 3D 模型", generating: "正在生成 3D 模型" },
        toolbar: {
        ...
        projectPage: { model3dMultiviewTrimmed: "多视图最多支持 {{count}} 张图片，已使用前 {{count}} 张",
        ...
        promptPanel: { model3d: "描述要生成的 3D 模型", model3dFromImage: "已连接图片，可直接生成；提示词选填", video: "描述要生成的视频内容", audio: "描述要生成的音频内容", image: "描述要生成的图片内容", text: "请输入你想要生成的文本内容", editImage: "请输入你想要把这张图修改成什么", editText: "请输入你想要将本段文本修改成什么", expandEditor: "放大编辑", editorTitle: "编辑提示词", stopGeneration: "停止生成", generate: "生成", stop: "停止" },
