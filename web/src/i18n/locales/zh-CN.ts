export default {
    ...
    canvas: {
        ...
        projectPage: { multiviewGroupTitle: "四视图", model3dMultiviewTrimmed: "多视图最多支持 {{count}} 张图片，已使用前 {{count}} 张", multiviewPartialFailure: "有 {{count}} 个视角生成失败，其余视角已保留", multiviewRateLimited: "触发生成并发上限，{{seconds}} 秒后重试这个视角",
