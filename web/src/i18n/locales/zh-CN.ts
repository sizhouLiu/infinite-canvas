export default {
    ...
    canvas: {
        ...
        multiview: { assignTitle: "指定这张图的视角" },
        ...
        promptPanel: { model3d: "描述要生成的 3D 模型", model3dSingleImageHint: "已连接 1 张图片，将进行图生 3D，无需提示词", model3dMultiviewHint: "已连接 {{count}} 张图片，将进行多视图生 3D，无需提示词。多视图生成的图片沿用自带视角，其余图片按连线顺序补上剩下的正/左/后/右视图", model3dMultiviewTrimmedHint: "已连接 {{count}} 张图片，多视图最多只用按连线顺序的前 {{max}} 张，无需提示词。多视图生成的图片沿用自带视角，其余图片补上剩下的正/左/后/右视图", video: "描述要生成的视频内容", audio: "描述要生成的音频内容", image: "描述要生成的图片内容", text: "请输入你想要生成的文本内容", editImage: "请输入你想要把这张图修改成什么", editText: "请输入你想要将本段文本修改成什么", expandEditor: "放大编辑", editorTitle: "编辑提示词", stopGeneration: "停止生成", generate: "生成", stop: "停止" },
